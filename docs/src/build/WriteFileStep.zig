...
<span class="line" id="L65">    <span class="tok-comment">// TODO port the cache system from stage1 to zig std lib. Until then we use blake2b</span>
</span>
<span class="line" id="L66">    <span class="tok-comment">// directly and construct the path, and no &quot;cache hit&quot; detection happens; the files</span>
</span>
<span class="line" id="L67">    <span class="tok-comment">// are always written.</span>
</span>
