...
<span class="line" id="L161">    <span class="tok-kw">const</span> target_info = std.zig.system.NativeTargetInfo.detect(builder.allocator, artifact.target) <span class="tok-kw">catch</span> <span class="tok-kw">unreachable</span>;</span>
