...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">    <title>target/arc.zig - source view</title>
...
<span class="line" id="L8">    norm,</span>
...
<span class="line" id="L20">    result[<span class="tok-builtin">@enumToInt</span>(Feature.norm)] = .{</span>
<span class="line" id="L21">        .llvm_name = <span class="tok-str">&quot;norm&quot;</span>,</span>
<span class="line" id="L22">        .description = <span class="tok-str">&quot;Enable support for norm instruction.&quot;</span>,</span>
...
<span class="line" id="L26">    <span class="tok-kw">for</span> (result) |*elem, i| {</span>
