...
<span class="line" id="L27">    <span class="tok-kw">const</span> u = <span class="tok-builtin">@bitCast</span>(<span class="tok-type">u32</span>, x);</span>
...
<span class="line" id="L45">    <span class="tok-kw">const</span> u = <span class="tok-builtin">@bitCast</span>(<span class="tok-type">u64</span>, x);</span>
