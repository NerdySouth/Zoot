...
<span class="line" id="L33">    <span class="tok-kw">var</span> y = <span class="tok-builtin">@bitCast</span>(<span class="tok-type">f32</span>, i); <span class="tok-comment">// |x|</span>
</span>
...
<span class="line" id="L58">    <span class="tok-kw">const</span> u = <span class="tok-builtin">@bitCast</span>(<span class="tok-type">u64</span>, x);</span>
...
<span class="line" id="L62">    <span class="tok-kw">var</span> y = <span class="tok-builtin">@bitCast</span>(<span class="tok-type">f64</span>, u &amp; (maxInt(<span class="tok-type">u64</span>) &gt;&gt; <span class="tok-number">1</span>)); <span class="tok-comment">// |x|</span>
</span>
...
<span class="line" id="L72">                math.doNotOptimizeAway(<span class="tok-builtin">@floatCast</span>(<span class="tok-type">f32</span>, y));</span>
