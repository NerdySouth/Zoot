...
<span class="line" id="L10">    <span class="tok-kw">const</span> mag = <span class="tok-builtin">@bitCast</span>(TBits, magnitude) &amp; ~sign_bit_mask;</span>
<span class="line" id="L11">    <span class="tok-kw">const</span> sgn = <span class="tok-builtin">@bitCast</span>(TBits, sign) &amp; sign_bit_mask;</span>
<span class="line" id="L12">    <span class="tok-kw">return</span> <span class="tok-builtin">@bitCast</span>(T, mag | sgn);</span>
<span class="line" id="L13">}</span>
<span class="line" id="L14"></span>
<span class="line" id="L15"><span class="tok-kw">test</span> <span class="tok-str">&quot;math.copysign&quot;</span> {</span>
<span class="line" id="L16">    <span class="tok-kw">inline</span> <span class="tok-kw">for</span> ([_]<span class="tok-type">type</span>{ <span class="tok-type">f16</span>, <span class="tok-type">f32</span>, <span class="tok-type">f64</span>, f80, <span class="tok-type">f128</span> }) |T| {</span>
