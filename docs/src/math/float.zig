...
<span class="line" id="L11"><span class="tok-kw">inline</span> <span class="tok-kw">fn</span> <span class="tok-fn">reconstructFloat</span>(<span class="tok-kw">comptime</span> T: <span class="tok-type">type</span>, exponent: <span class="tok-type">comptime_int</span>, mantissa: <span class="tok-type">comptime_int</span>) T {</span>
...
<span class="line" id="L101">    <span class="tok-kw">inline</span> <span class="tok-kw">for</span> ([_]<span class="tok-type">type</span>{ <span class="tok-type">f16</span>, <span class="tok-type">f32</span>, <span class="tok-type">f64</span>, f80, <span class="tok-type">f128</span>, <span class="tok-type">c_longdouble</span> }) |T| {</span>
