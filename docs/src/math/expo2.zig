...
<span class="line" id="L24">    <span class="tok-kw">const</span> scale = <span class="tok-builtin">@bitCast</span>(<span class="tok-type">f32</span>, u);</span>
...
<span class="line" id="L33">    <span class="tok-kw">const</span> scale = <span class="tok-builtin">@bitCast</span>(<span class="tok-type">f64</span>, <span class="tok-builtin">@as</span>(<span class="tok-type">u64</span>, u) &lt;&lt; <span class="tok-number">32</span>);</span>
