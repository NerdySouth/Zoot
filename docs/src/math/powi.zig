...
<span class="line" id="L73">            <span class="tok-kw">if</span> (<span class="tok-builtin">@mulWithOverflow</span>(T, acc, base, &amp;acc)) {</span>
<span class="line" id="L74">                <span class="tok-kw">return</span> <span class="tok-kw">error</span>.Overflow;</span>
<span class="line" id="L75">            }</span>
<span class="line" id="L76">        }</span>
<span class="line" id="L77"></span>
<span class="line" id="L78">        exp &gt;&gt;= <span class="tok-number">1</span>;</span>
<span class="line" id="L79"></span>
<span class="line" id="L80">        <span class="tok-kw">if</span> (<span class="tok-builtin">@mulWithOverflow</span>(T, base, base, &amp;base)) {</span>
<span class="line" id="L81">            <span class="tok-kw">return</span> <span class="tok-kw">error</span>.Overflow;</span>
<span class="line" id="L82">        }</span>
<span class="line" id="L83">    }</span>
<span class="line" id="L84"></span>
<span class="line" id="L85">    <span class="tok-kw">if</span> (exp == <span class="tok-number">1</span>) {</span>
<span class="line" id="L86">        <span class="tok-kw">if</span> (<span class="tok-builtin">@mulWithOverflow</span>(T, acc, base, &amp;acc)) {</span>
<span class="line" id="L87">            <span class="tok-kw">return</span> <span class="tok-kw">error</span>.Overflow;</span>
