...
<span class="line" id="L204">                <span class="tok-kw">const</span> resolve_paths: [][]<span class="tok-kw">const</span> <span class="tok-type">u8</span> = <span class="tok-kw">if</span> (raw_path[<span class="tok-number">0</span>] == <span class="tok-str">'.'</span>) &amp;.{ cwd, raw_path } <span class="tok-kw">else</span> &amp;.{ <span class="tok-str">&quot;/&quot;</span>, raw_path };</span>
