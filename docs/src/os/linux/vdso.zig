...
<span class="line" id="L71">        <span class="tok-kw">const</span> sym_name = std.meta.assumeSentinel(strings + syms[i].st_name, <span class="tok-number">0</span>);</span>
...
<span class="line" id="L94">    <span class="tok-kw">const</span> vda_name = std.meta.assumeSentinel(strings + aux.vda_name, <span class="tok-number">0</span>);</span>
