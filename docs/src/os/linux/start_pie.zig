...
<span class="line" id="L14">    .<span class="tok-type">i386</span> =&gt; R_386_RELATIVE,</span>
...
<span class="line" id="L27">        .<span class="tok-type">i386</span> =&gt; <span class="tok-kw">asm</span> <span class="tok-kw">volatile</span> (</span>
