...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">    <title>os/linux/tls.zig - source view</title>
...
<span class="line" id="L33"><span class="tok-comment">// for a single pointer as some architectures such as i386 and x86_64 need a</span>
</span>
...
<span class="line" id="L51">    .arm, .armeb, .thumb, .aarch64, .aarch64_be, .riscv32, .riscv64, .mips, .mipsel, .powerpc, .powerpc64, .powerpc64le =&gt; TLSVariant.VariantI,</span>
<span class="line" id="L52">    .x86_64, .<span class="tok-type">i386</span>, .sparc64 =&gt; TLSVariant.VariantII,</span>
...
<span class="line" id="L67">    .riscv32, .riscv64, .mips, .mipsel, .powerpc, .powerpc64, .powerpc64le =&gt; <span class="tok-null">true</span>,</span>
...
<span class="line" id="L75">    .mips, .mipsel, .powerpc, .powerpc64, .powerpc64le =&gt; <span class="tok-number">0x7000</span>,</span>
...
<span class="line" id="L80">    .mips, .mipsel, .powerpc, .powerpc64, .powerpc64le =&gt; <span class="tok-number">0x8000</span>,</span>
...
<span class="line" id="L105">    <span class="tok-comment">// Only used on the i386 architecture</span>
</span>
...
<span class="line" id="L113">        .<span class="tok-type">i386</span> =&gt; {</span>
...
<span class="line" id="L159">        .mips, .mipsel =&gt; {</span>
