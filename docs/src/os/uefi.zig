...
<span class="line" id="L38"><span class="tok-comment">/// GUIDs must be align(8)</span></span>
...
<span class="line" id="L58">            <span class="tok-kw">const</span> time_low = <span class="tok-builtin">@byteSwap</span>(<span class="tok-type">u32</span>, self.time_low);</span>
<span class="line" id="L59">            <span class="tok-kw">const</span> time_mid = <span class="tok-builtin">@byteSwap</span>(<span class="tok-type">u16</span>, self.time_mid);</span>
<span class="line" id="L60">            <span class="tok-kw">const</span> time_high_and_version = <span class="tok-builtin">@byteSwap</span>(<span class="tok-type">u16</span>, self.time_high_and_version);</span>
...
<span class="line" id="L71">            <span class="tok-builtin">@compileError</span>(<span class="tok-str">&quot;Unknown format character: '&quot;</span> ++ f ++ <span class="tok-str">&quot;'&quot;</span>);</span>
