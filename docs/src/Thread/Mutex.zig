...
<span class="line" id="L143">            <span class="tok-kw">const</span> locked_bit = <span class="tok-builtin">@ctz</span>(<span class="tok-type">u32</span>, <span class="tok-builtin">@as</span>(<span class="tok-type">u32</span>, locked));</span>
