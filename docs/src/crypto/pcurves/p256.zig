...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">    <title>crypto/pcurves/p256.zig - source view</title>
...
<span class="line" id="L11"><span class="tok-comment">/// Group operations over P256.</span></span>
<span class="line" id="L12"><span class="tok-kw">pub</span> <span class="tok-kw">const</span> P256 = <span class="tok-kw">struct</span> {</span>
<span class="line" id="L13">    <span class="tok-comment">/// The underlying prime field.</span></span>
<span class="line" id="L14">    <span class="tok-kw">pub</span> <span class="tok-kw">const</span> Fe = <span class="tok-builtin">@import</span>(<span class="tok-str">&quot;p256/field.zig&quot;</span>).Fe;</span>
<span class="line" id="L15">    <span class="tok-comment">/// Field arithmetic mod the order of the main subgroup.</span></span>
<span class="line" id="L16">    <span class="tok-kw">pub</span> <span class="tok-kw">const</span> scalar = <span class="tok-builtin">@import</span>(<span class="tok-str">&quot;p256/scalar.zig&quot;</span>);</span>
...
<span class="line" id="L24">    <span class="tok-comment">/// The P256 base point.</span></span>
<span class="line" id="L25">    <span class="tok-kw">pub</span> <span class="tok-kw">const</span> basePoint = P256{</span>
<span class="line" id="L26">        .x = Fe.fromInt(<span class="tok-number">48439561293906451759052585252797914202762949526041747995844080717082404635286</span>) <span class="tok-kw">catch</span> <span class="tok-kw">unreachable</span>,</span>
<span class="line" id="L27">        .y = Fe.fromInt(<span class="tok-number">36134250956749795798585127919587881956611106672985015071877198253568414405109</span>) <span class="tok-kw">catch</span> <span class="tok-kw">unreachable</span>,</span>
<span class="line" id="L28">        .z = Fe.one,</span>
<span class="line" id="L29">        .is_base = <span class="tok-null">true</span>,</span>
<span class="line" id="L30">    };</span>
<span class="line" id="L31"></span>
<span class="line" id="L32">    <span class="tok-comment">/// The P256 neutral element.</span></span>
<span class="line" id="L33">    <span class="tok-kw">pub</span> <span class="tok-kw">const</span> identityElement = P256{ .x = Fe.zero, .y = Fe.one, .z = Fe.zero };</span>
<span class="line" id="L34"></span>
<span class="line" id="L35">    <span class="tok-kw">pub</span> <span class="tok-kw">const</span> B = Fe.fromInt(<span class="tok-number">41058363725152142129326129780047268409114441015993725554835256314039467401291</span>) <span class="tok-kw">catch</span> <span class="tok-kw">unreachable</span>;</span>
<span class="line" id="L36"></span>
<span class="line" id="L37">    <span class="tok-comment">/// Reject the neutral element.</span></span>
<span class="line" id="L38">    <span class="tok-kw">pub</span> <span class="tok-kw">fn</span> <span class="tok-fn">rejectIdentity</span>(p: P256) IdentityElementError!<span class="tok-type">void</span> {</span>
...
<span class="line" id="L45">    <span class="tok-kw">pub</span> <span class="tok-kw">fn</span> <span class="tok-fn">fromAffineCoordinates</span>(p: AffineCoordinates) EncodingError!P256 {</span>
...
<span class="line" id="L55">        <span class="tok-kw">var</span> ret = P256{ .x = x, .y = y, .z = Fe.one };</span>
<span class="line" id="L56">        ret.z.cMov(P256.identityElement.z, is_identity);</span>
...
<span class="line" id="L61">    <span class="tok-kw">pub</span> <span class="tok-kw">fn</span> <span class="tok-fn">fromSerializedAffineCoordinates</span>(xs: [<span class="tok-number">32</span>]<span class="tok-type">u8</span>, ys: [<span class="tok-number">32</span>]<span class="tok-type">u8</span>, endian: std.builtin.Endian) (NonCanonicalError || EncodingError)!P256 {</span>
...
<span class="line" id="L77">    <span class="tok-kw">pub</span> <span class="tok-kw">fn</span> <span class="tok-fn">fromSec1</span>(s: []<span class="tok-kw">const</span> <span class="tok-type">u8</span>) (EncodingError || NotSquareError || NonCanonicalError)!P256 {</span>
...
<span class="line" id="L84">                <span class="tok-kw">return</span> P256.identityElement;</span>
<span class="line" id="L85">            },</span>
<span class="line" id="L86">            <span class="tok-number">2</span>, <span class="tok-number">3</span> =&gt; {</span>
<span class="line" id="L87">                <span class="tok-kw">if</span> (encoded.len != <span class="tok-number">32</span>) <span class="tok-kw">return</span> <span class="tok-kw">error</span>.InvalidEncoding;</span>
<span class="line" id="L88">                <span class="tok-kw">const</span> x = <span class="tok-kw">try</span> Fe.fromBytes(encoded[<span class="tok-number">0</span>..<span class="tok-number">32</span>].*, .Big);</span>
...
<span class="line" id="L91">                <span class="tok-kw">return</span> P256{ .x = x, .y = y };</span>
<span class="line" id="L92">            },</span>
<span class="line" id="L93">            <span class="tok-number">4</span> =&gt; {</span>
<span class="line" id="L94">                <span class="tok-kw">if</span> (encoded.len != <span class="tok-number">64</span>) <span class="tok-kw">return</span> <span class="tok-kw">error</span>.InvalidEncoding;</span>
<span class="line" id="L95">                <span class="tok-kw">const</span> x = <span class="tok-kw">try</span> Fe.fromBytes(encoded[<span class="tok-number">0</span>..<span class="tok-number">32</span>].*, .Big);</span>
<span class="line" id="L96">                <span class="tok-kw">const</span> y = <span class="tok-kw">try</span> Fe.fromBytes(encoded[<span class="tok-number">32</span>..<span class="tok-number">64</span>].*, .Big);</span>
<span class="line" id="L97">                <span class="tok-kw">return</span> P256.fromAffineCoordinates(.{ .x = x, .y = y });</span>
...
<span class="line" id="L104">    <span class="tok-kw">pub</span> <span class="tok-kw">fn</span> <span class="tok-fn">toCompressedSec1</span>(p: P256) [<span class="tok-number">33</span>]<span class="tok-type">u8</span> {</span>
<span class="line" id="L105">        <span class="tok-kw">var</span> out: [<span class="tok-number">33</span>]<span class="tok-type">u8</span> = <span class="tok-null">undefined</span>;</span>
...
<span class="line" id="L113">    <span class="tok-kw">pub</span> <span class="tok-kw">fn</span> <span class="tok-fn">toUncompressedSec1</span>(p: P256) [<span class="tok-number">65</span>]<span class="tok-type">u8</span> {</span>
<span class="line" id="L114">        <span class="tok-kw">var</span> out: [<span class="tok-number">65</span>]<span class="tok-type">u8</span> = <span class="tok-null">undefined</span>;</span>
...
<span class="line" id="L117">        mem.copy(<span class="tok-type">u8</span>, out[<span class="tok-number">1</span>..<span class="tok-number">33</span>], &amp;xy.x.toBytes(.Big));</span>
<span class="line" id="L118">        mem.copy(<span class="tok-type">u8</span>, out[<span class="tok-number">33</span>..<span class="tok-number">65</span>], &amp;xy.y.toBytes(.Big));</span>
...
<span class="line" id="L123">    <span class="tok-kw">pub</span> <span class="tok-kw">fn</span> <span class="tok-fn">random</span>() P256 {</span>
...
<span class="line" id="L129">    <span class="tok-kw">pub</span> <span class="tok-kw">fn</span> <span class="tok-fn">neg</span>(p: P256) P256 {</span>
<span class="line" id="L130">        <span class="tok-kw">return</span> .{ .x = p.x, .y = p.y.neg(), .z = p.z };</span>
<span class="line" id="L131">    }</span>
<span class="line" id="L132"></span>
<span class="line" id="L133">    <span class="tok-comment">/// Double a P256 point.</span></span>
<span class="line" id="L134">    <span class="tok-comment">// Algorithm 6 from https://eprint.iacr.org/2015/1060.pdf</span>
</span>
<span class="line" id="L135">    <span class="tok-kw">pub</span> <span class="tok-kw">fn</span> <span class="tok-fn">dbl</span>(p: P256) P256 {</span>
...
<span class="line" id="L176">    <span class="tok-comment">/// Add P256 points, the second being specified using affine coordinates.</span></span>
<span class="line" id="L177">    <span class="tok-comment">// Algorithm 5 from https://eprint.iacr.org/2015/1060.pdf</span>
</span>
<span class="line" id="L178">    <span class="tok-kw">pub</span> <span class="tok-kw">fn</span> <span class="tok-fn">addMixed</span>(p: P256, q: AffineCoordinates) P256 {</span>
...
<span class="line" id="L215">        <span class="tok-kw">var</span> ret = P256{</span>
...
<span class="line" id="L224">    <span class="tok-comment">/// Add P256 points.</span></span>
<span class="line" id="L225">    <span class="tok-comment">// Algorithm 4 from https://eprint.iacr.org/2015/1060.pdf</span>
</span>
<span class="line" id="L226">    <span class="tok-kw">pub</span> <span class="tok-kw">fn</span> <span class="tok-fn">add</span>(p: P256, q: P256) P256 {</span>
...
<span class="line" id="L277">    <span class="tok-comment">/// Subtract P256 points.</span></span>
<span class="line" id="L278">    <span class="tok-kw">pub</span> <span class="tok-kw">fn</span> <span class="tok-fn">sub</span>(p: P256, q: P256) P256 {</span>
<span class="line" id="L279">        <span class="tok-kw">return</span> p.add(q.neg());</span>
<span class="line" id="L280">    }</span>
<span class="line" id="L281"></span>
<span class="line" id="L282">    <span class="tok-comment">/// Subtract P256 points, the second being specified using affine coordinates.</span></span>
<span class="line" id="L283">    <span class="tok-kw">pub</span> <span class="tok-kw">fn</span> <span class="tok-fn">subMixed</span>(p: P256, q: AffineCoordinates) P256 {</span>
...
<span class="line" id="L288">    <span class="tok-kw">pub</span> <span class="tok-kw">fn</span> <span class="tok-fn">affineCoordinates</span>(p: P256) AffineCoordinates {</span>
...
<span class="line" id="L299">    <span class="tok-kw">pub</span> <span class="tok-kw">fn</span> <span class="tok-fn">equivalent</span>(a: P256, b: P256) <span class="tok-type">bool</span> {</span>
...
<span class="line" id="L307">    <span class="tok-kw">fn</span> <span class="tok-fn">cMov</span>(p: *P256, a: P256, c: <span class="tok-type">u1</span>) <span class="tok-type">void</span> {</span>
...
<span class="line" id="L313">    <span class="tok-kw">fn</span> <span class="tok-fn">pcSelect</span>(<span class="tok-kw">comptime</span> n: <span class="tok-type">usize</span>, pc: *<span class="tok-kw">const</span> [n]P256, b: <span class="tok-type">u8</span>) P256 {</span>
<span class="line" id="L314">        <span class="tok-kw">var</span> t = P256.identityElement;</span>
...
<span class="line" id="L322">    <span class="tok-kw">fn</span> <span class="tok-fn">slide</span>(s: [<span class="tok-number">32</span>]<span class="tok-type">u8</span>) [<span class="tok-number">2</span> * <span class="tok-number">32</span> + <span class="tok-number">1</span>]<span class="tok-type">i8</span> {</span>
<span class="line" id="L323">        <span class="tok-kw">var</span> e: [<span class="tok-number">2</span> * <span class="tok-number">32</span> + <span class="tok-number">1</span>]<span class="tok-type">i8</span> = <span class="tok-null">undefined</span>;</span>
...
<span class="line" id="L330">        <span class="tok-kw">for</span> (e[<span class="tok-number">0</span>..<span class="tok-number">64</span>]) |*x| {</span>
...
<span class="line" id="L336">        e[<span class="tok-number">64</span>] = carry;</span>
...
<span class="line" id="L342">    <span class="tok-kw">fn</span> <span class="tok-fn">pcMul</span>(pc: *<span class="tok-kw">const</span> [<span class="tok-number">9</span>]P256, s: [<span class="tok-number">32</span>]<span class="tok-type">u8</span>, <span class="tok-kw">comptime</span> vartime: <span class="tok-type">bool</span>) IdentityElementError!P256 {</span>
<span class="line" id="L343">        std.debug.assert(vartime);</span>
<span class="line" id="L344">        <span class="tok-kw">const</span> e = slide(s);</span>
<span class="line" id="L345">        <span class="tok-kw">var</span> q = P256.identityElement;</span>
...
<span class="line" id="L361">    <span class="tok-kw">fn</span> <span class="tok-fn">pcMul16</span>(pc: *<span class="tok-kw">const</span> [<span class="tok-number">16</span>]P256, s: [<span class="tok-number">32</span>]<span class="tok-type">u8</span>, <span class="tok-kw">comptime</span> vartime: <span class="tok-type">bool</span>) IdentityElementError!P256 {</span>
<span class="line" id="L362">        <span class="tok-kw">var</span> q = P256.identityElement;</span>
<span class="line" id="L363">        <span class="tok-kw">var</span> pos: <span class="tok-type">usize</span> = <span class="tok-number">252</span>;</span>
...
<span class="line" id="L380">    <span class="tok-kw">fn</span> <span class="tok-fn">precompute</span>(p: P256, <span class="tok-kw">comptime</span> count: <span class="tok-type">usize</span>) [<span class="tok-number">1</span> + count]P256 {</span>
<span class="line" id="L381">        <span class="tok-kw">var</span> pc: [<span class="tok-number">1</span> + count]P256 = <span class="tok-null">undefined</span>;</span>
<span class="line" id="L382">        pc[<span class="tok-number">0</span>] = P256.identityElement;</span>
...
<span class="line" id="L393">        <span class="tok-kw">break</span> :pc precompute(P256.basePoint, <span class="tok-number">15</span>);</span>
...
<span class="line" id="L398">    <span class="tok-kw">pub</span> <span class="tok-kw">fn</span> <span class="tok-fn">mul</span>(p: P256, s_: [<span class="tok-number">32</span>]<span class="tok-type">u8</span>, endian: std.builtin.Endian) IdentityElementError!P256 {</span>
...
<span class="line" id="L410">    <span class="tok-kw">pub</span> <span class="tok-kw">fn</span> <span class="tok-fn">mulPublic</span>(p: P256, s_: [<span class="tok-number">32</span>]<span class="tok-type">u8</span>, endian: std.builtin.Endian) IdentityElementError!P256 {</span>
...
<span class="line" id="L422">    <span class="tok-kw">pub</span> <span class="tok-kw">fn</span> <span class="tok-fn">mulDoubleBasePublic</span>(p1: P256, s1_: [<span class="tok-number">32</span>]<span class="tok-type">u8</span>, p2: P256, s2_: [<span class="tok-number">32</span>]<span class="tok-type">u8</span>, endian: std.builtin.Endian) IdentityElementError!P256 {</span>
...
<span class="line" id="L426">        <span class="tok-kw">var</span> pc1_array: [<span class="tok-number">9</span>]P256 = <span class="tok-null">undefined</span>;</span>
...
<span class="line" id="L432">        <span class="tok-kw">var</span> pc2_array: [<span class="tok-number">9</span>]P256 = <span class="tok-null">undefined</span>;</span>
...
<span class="line" id="L439">        <span class="tok-kw">var</span> q = P256.identityElement;</span>
<span class="line" id="L440">        <span class="tok-kw">var</span> pos: <span class="tok-type">usize</span> = <span class="tok-number">2</span> * <span class="tok-number">32</span>;</span>
...
<span class="line" id="L464">    x: P256.Fe,</span>
<span class="line" id="L465">    y: P256.Fe,</span>
<span class="line" id="L466"></span>
<span class="line" id="L467">    <span class="tok-comment">/// Identity element in affine coordinates.</span></span>
<span class="line" id="L468">    <span class="tok-kw">pub</span> <span class="tok-kw">const</span> identityElement = AffineCoordinates{ .x = P256.identityElement.x, .y = P256.identityElement.y };</span>
...
<span class="line" id="L476"><span class="tok-kw">test</span> <span class="tok-str">&quot;p256&quot;</span> {</span>
<span class="line" id="L477">    _ = <span class="tok-builtin">@import</span>(<span class="tok-str">&quot;tests/p256.zig&quot;</span>);</span>
