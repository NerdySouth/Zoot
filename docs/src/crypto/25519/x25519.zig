...
<span class="line" id="L47">            <span class="tok-kw">const</span> seed = ed25519_key_pair.secret_key[<span class="tok-number">0</span>..<span class="tok-number">32</span>];</span>
...
<span class="line" id="L67">    <span class="tok-kw">pub</span> <span class="tok-kw">fn</span> <span class="tok-fn">publicKeyFromEd25519</span>(ed25519_public_key: [crypto.sign.Ed25519.public_length]<span class="tok-type">u8</span>) (IdentityElementError || EncodingError)![public_length]<span class="tok-type">u8</span> {</span>
<span class="line" id="L68">        <span class="tok-kw">const</span> pk_ed = <span class="tok-kw">try</span> crypto.ecc.Edwards25519.fromBytes(ed25519_public_key);</span>
