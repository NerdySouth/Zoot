...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">    <title>compress/deflate/token.zig - source view</title>
...
<span class="line" id="L102">    <span class="tok-kw">const</span> expect = std.testing.expect;</span>
<span class="line" id="L103">    <span class="tok-kw">try</span> expect(matchToken(<span class="tok-number">555</span>, <span class="tok-number">555</span>) == <span class="tok-number">3_401_581_099</span>);</span>
