...
<span class="line" id="L101"><span class="tok-kw">const</span> please_windows_dont_oom = builtin.os.tag == .windows;</span>
<span class="line" id="L102"></span>
<span class="line" id="L103"><span class="tok-kw">test</span> <span class="tok-str">&quot;crc32 ieee&quot;</span> {</span>
<span class="line" id="L104">    <span class="tok-kw">if</span> (please_windows_dont_oom) <span class="tok-kw">return</span> <span class="tok-kw">error</span>.SkipZigTest;</span>
<span class="line" id="L105"></span>
<span class="line" id="L106">    <span class="tok-kw">const</span> Crc32Ieee = Crc32WithPoly(.IEEE);</span>
<span class="line" id="L107"></span>
<span class="line" id="L108">    <span class="tok-kw">try</span> testing.expect(Crc32Ieee.hash(<span class="tok-str">&quot;&quot;</span>) == <span class="tok-number">0x00000000</span>);</span>
<span class="line" id="L109">    <span class="tok-kw">try</span> testing.expect(Crc32Ieee.hash(<span class="tok-str">&quot;a&quot;</span>) == <span class="tok-number">0xe8b7be43</span>);</span>
<span class="line" id="L110">    <span class="tok-kw">try</span> testing.expect(Crc32Ieee.hash(<span class="tok-str">&quot;abc&quot;</span>) == <span class="tok-number">0x352441c2</span>);</span>
<span class="line" id="L111">}</span>
<span class="line" id="L112"></span>
<span class="line" id="L113"><span class="tok-kw">test</span> <span class="tok-str">&quot;crc32 castagnoli&quot;</span> {</span>
<span class="line" id="L114">    <span class="tok-kw">if</span> (please_windows_dont_oom) <span class="tok-kw">return</span> <span class="tok-kw">error</span>.SkipZigTest;</span>
<span class="line" id="L115"></span>
<span class="line" id="L116">    <span class="tok-kw">const</span> Crc32Castagnoli = Crc32WithPoly(.Castagnoli);</span>
<span class="line" id="L117"></span>
<span class="line" id="L118">    <span class="tok-kw">try</span> testing.expect(Crc32Castagnoli.hash(<span class="tok-str">&quot;&quot;</span>) == <span class="tok-number">0x00000000</span>);</span>
<span class="line" id="L119">    <span class="tok-kw">try</span> testing.expect(Crc32Castagnoli.hash(<span class="tok-str">&quot;a&quot;</span>) == <span class="tok-number">0xc1d04330</span>);</span>
<span class="line" id="L120">    <span class="tok-kw">try</span> testing.expect(Crc32Castagnoli.hash(<span class="tok-str">&quot;abc&quot;</span>) == <span class="tok-number">0x364b3fb7</span>);</span>
<span class="line" id="L121">}</span>
<span class="line" id="L122"></span>
<span class="line" id="L123"><span class="tok-comment">// half-byte lookup table implementation.</span>
</span>
<span class="line" id="L124"><span class="tok-kw">pub</span> <span class="tok-kw">fn</span> <span class="tok-fn">Crc32SmallWithPoly</span>(<span class="tok-kw">comptime</span> poly: Polynomial) <span class="tok-type">type</span> {</span>
<span class="line" id="L125">    <span class="tok-kw">return</span> <span class="tok-kw">struct</span> {</span>
<span class="line" id="L126">        <span class="tok-kw">const</span> Self = <span class="tok-builtin">@This</span>();</span>
<span class="line" id="L127">        <span class="tok-kw">const</span> lookup_table = block: {</span>
<span class="line" id="L128">            <span class="tok-kw">var</span> table: [<span class="tok-number">16</span>]<span class="tok-type">u32</span> = <span class="tok-null">undefined</span>;</span>
<span class="line" id="L129"></span>
<span class="line" id="L130">            <span class="tok-kw">for</span> (table) |*e, i| {</span>
<span class="line" id="L131">                <span class="tok-kw">var</span> crc = <span class="tok-builtin">@intCast</span>(<span class="tok-type">u32</span>, i * <span class="tok-number">16</span>);</span>
<span class="line" id="L132">                <span class="tok-kw">var</span> j: <span class="tok-type">usize</span> = <span class="tok-number">0</span>;</span>
<span class="line" id="L133">                <span class="tok-kw">while</span> (j &lt; <span class="tok-number">8</span>) : (j += <span class="tok-number">1</span>) {</span>
<span class="line" id="L134">                    <span class="tok-kw">if</span> (crc &amp; <span class="tok-number">1</span> == <span class="tok-number">1</span>) {</span>
<span class="line" id="L135">                        crc = (crc &gt;&gt; <span class="tok-number">1</span>) ^ <span class="tok-builtin">@enumToInt</span>(poly);</span>
<span class="line" id="L136">                    } <span class="tok-kw">else</span> {</span>
<span class="line" id="L137">                        crc = (crc &gt;&gt; <span class="tok-number">1</span>);</span>
<span class="line" id="L138">                    }</span>
<span class="line" id="L139">                }</span>
<span class="line" id="L140">                e.* = crc;</span>
<span class="line" id="L141">            }</span>
<span class="line" id="L142"></span>
<span class="line" id="L143">            <span class="tok-kw">break</span> :block table;</span>
<span class="line" id="L144">        };</span>
<span class="line" id="L145"></span>
<span class="line" id="L146">        crc: <span class="tok-type">u32</span>,</span>
<span class="line" id="L147"></span>
<span class="line" id="L148">        <span class="tok-kw">pub</span> <span class="tok-kw">fn</span> <span class="tok-fn">init</span>() Self {</span>
<span class="line" id="L149">            <span class="tok-kw">return</span> Self{ .crc = <span class="tok-number">0xffffffff</span> };</span>
<span class="line" id="L150">        }</span>
<span class="line" id="L151"></span>
<span class="line" id="L152">        <span class="tok-kw">pub</span> <span class="tok-kw">fn</span> <span class="tok-fn">update</span>(self: *Self, input: []<span class="tok-kw">const</span> <span class="tok-type">u8</span>) <span class="tok-type">void</span> {</span>
<span class="line" id="L153">            <span class="tok-kw">for</span> (input) |b| {</span>
<span class="line" id="L154">                self.crc = lookup_table[<span class="tok-builtin">@truncate</span>(<span class="tok-type">u4</span>, self.crc ^ (b &gt;&gt; <span class="tok-number">0</span>))] ^ (self.crc &gt;&gt; <span class="tok-number">4</span>);</span>
<span class="line" id="L155">                self.crc = lookup_table[<span class="tok-builtin">@truncate</span>(<span class="tok-type">u4</span>, self.crc ^ (b &gt;&gt; <span class="tok-number">4</span>))] ^ (self.crc &gt;&gt; <span class="tok-number">4</span>);</span>
<span class="line" id="L156">            }</span>
<span class="line" id="L157">        }</span>
<span class="line" id="L158"></span>
<span class="line" id="L159">        <span class="tok-kw">pub</span> <span class="tok-kw">fn</span> <span class="tok-fn">final</span>(self: *Self) <span class="tok-type">u32</span> {</span>
<span class="line" id="L160">            <span class="tok-kw">return</span> ~self.crc;</span>
<span class="line" id="L161">        }</span>
<span class="line" id="L162"></span>
<span class="line" id="L163">        <span class="tok-kw">pub</span> <span class="tok-kw">fn</span> <span class="tok-fn">hash</span>(input: []<span class="tok-kw">const</span> <span class="tok-type">u8</span>) <span class="tok-type">u32</span> {</span>
<span class="line" id="L164">            <span class="tok-kw">var</span> c = Self.init();</span>
<span class="line" id="L165">            c.update(input);</span>
<span class="line" id="L166">            <span class="tok-kw">return</span> c.final();</span>
<span class="line" id="L167">        }</span>
<span class="line" id="L168">    };</span>
<span class="line" id="L169">}</span>
<span class="line" id="L170"></span>
<span class="line" id="L171"><span class="tok-kw">test</span> <span class="tok-str">&quot;small crc32 ieee&quot;</span> {</span>
<span class="line" id="L172">    <span class="tok-kw">if</span> (please_windows_dont_oom) <span class="tok-kw">return</span> <span class="tok-kw">error</span>.SkipZigTest;</span>
<span class="line" id="L173"></span>
<span class="line" id="L174">    <span class="tok-kw">const</span> Crc32Ieee = Crc32SmallWithPoly(.IEEE);</span>
<span class="line" id="L175"></span>
<span class="line" id="L176">    <span class="tok-kw">try</span> testing.expect(Crc32Ieee.hash(<span class="tok-str">&quot;&quot;</span>) == <span class="tok-number">0x00000000</span>);</span>
<span class="line" id="L177">    <span class="tok-kw">try</span> testing.expect(Crc32Ieee.hash(<span class="tok-str">&quot;a&quot;</span>) == <span class="tok-number">0xe8b7be43</span>);</span>
<span class="line" id="L178">    <span class="tok-kw">try</span> testing.expect(Crc32Ieee.hash(<span class="tok-str">&quot;abc&quot;</span>) == <span class="tok-number">0x352441c2</span>);</span>
<span class="line" id="L179">}</span>
<span class="line" id="L180"></span>
<span class="line" id="L181"><span class="tok-kw">test</span> <span class="tok-str">&quot;small crc32 castagnoli&quot;</span> {</span>
<span class="line" id="L182">    <span class="tok-kw">if</span> (please_windows_dont_oom) <span class="tok-kw">return</span> <span class="tok-kw">error</span>.SkipZigTest;</span>
<span class="line" id="L183"></span>
<span class="line" id="L184">    <span class="tok-kw">const</span> Crc32Castagnoli = Crc32SmallWithPoly(.Castagnoli);</span>
<span class="line" id="L185"></span>
<span class="line" id="L186">    <span class="tok-kw">try</span> testing.expect(Crc32Castagnoli.hash(<span class="tok-str">&quot;&quot;</span>) == <span class="tok-number">0x00000000</span>);</span>
<span class="line" id="L187">    <span class="tok-kw">try</span> testing.expect(Crc32Castagnoli.hash(<span class="tok-str">&quot;a&quot;</span>) == <span class="tok-number">0xc1d04330</span>);</span>
<span class="line" id="L188">    <span class="tok-kw">try</span> testing.expect(Crc32Castagnoli.hash(<span class="tok-str">&quot;abc&quot;</span>) == <span class="tok-number">0x364b3fb7</span>);</span>
