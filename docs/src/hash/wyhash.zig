...
<span class="line" id="L68">            <span class="tok-builtin">@call</span>(.{ .modifier = .always_inline }, self.round, .{b[off .. off + <span class="tok-number">32</span>]});</span>
...
<span class="line" id="L124">        <span class="tok-builtin">@call</span>(.{ .modifier = .always_inline }, c.update, .{input[<span class="tok-number">0</span>..aligned_len]});</span>
<span class="line" id="L125">        <span class="tok-kw">return</span> <span class="tok-builtin">@call</span>(.{ .modifier = .always_inline }, c.final, .{input[aligned_len..]});</span>
...
<span class="line" id="L210">    <span class="tok-kw">for</span> (buf) |*e, i| {</span>
