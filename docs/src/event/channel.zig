...
<span class="line" id="L59">            assert(buffer.len == <span class="tok-number">0</span> <span class="tok-kw">or</span> <span class="tok-builtin">@popCount</span>(<span class="tok-type">usize</span>, buffer.len) == <span class="tok-number">1</span>);</span>
