...
<span class="line" id="L20">        <span class="tok-comment">/// `std.io.mode == .blocking`. This is a generally safe assumption, and the</span></span>
...
<span class="line" id="L112">    <span class="tok-kw">if</span> (<span class="tok-builtin">@import</span>(<span class="tok-str">&quot;builtin&quot;</span>).zig_backend != .stage1) <span class="tok-kw">return</span> <span class="tok-kw">error</span>.SkipZigTest;</span>
