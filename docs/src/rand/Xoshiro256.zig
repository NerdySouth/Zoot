...
<span class="line" id="L25"><span class="tok-kw">fn</span> <span class="tok-fn">next</span>(self: *Xoshiro256) <span class="tok-type">u64</span> {</span>
...
<span class="line" id="L43"><span class="tok-kw">fn</span> <span class="tok-fn">jump</span>(self: *Xoshiro256) <span class="tok-type">void</span> {</span>
